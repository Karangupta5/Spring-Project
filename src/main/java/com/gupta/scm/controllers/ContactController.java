...
import com.gupta.scm.forms.ContactForm;
import com.gupta.scm.helpers.AppConstants;
import com.gupta.scm.forms.ContactSearchForm;
...
import com.gupta.scm.services.imageService;
...
public class ContactController {
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm,BindingResult result,
        ...
        contact.setWebsiteLink(contactForm.getInstaLink());
    ...
    public String viewContacts(
     ...
     public String updateContactFormView(
         ...
         contactForm.setInstaLink(contact.getWebsiteLink());
     ...
     public String updateContact(@PathVariable("contactId") String contactId,
         ...
         con.setWebsiteLink(contactForm.getInstaLink());
